...
class Config():
    ...
    # 语言模型 提高效果
    # glove files
    filename_glove = "data\\embedding\\word2vec.bm.300d.txt"
    ...
    # training
    train_embeddings = False # word-embedding 词嵌入
    nepochs          = 1 # 迭代次数100
    dropout          = 0.5 # 参数过多，参数丢弃。
    batch_size       = 1 # 每个时间片处理的大小
    lr_method        = "adam"  # 优化算法 SGD
    lr               = 0.001 #
    lr_decay         = 0.9 #
    clip             = -1
    nepoch_no_imprv  = 5 # 连续5轮
    momentum=0.9
